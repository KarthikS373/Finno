...
function Floater({ heading, subheading, buttonClick, buttonText } : FloaterProps) {
  return (
    <div className="shadow-2xl h-full max-w-[40%] rounded-3xl px-20 py-10 text-center">
      <span className="flex h-full flex-col items-center justify-between">
        ...
        <div onClick={buttonClick} className="shadow-cool mt-5 w-full rounded-3xl bg-blue-600 p-3 text-white hover:bg-blue-500 cursor-pointer ">
          {buttonText}
        </div>
      </span>
    </div>
